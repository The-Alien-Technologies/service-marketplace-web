...
test("super admins default to global unless they saved a market preference", () => {
  assert.equal(suggestMarketCode(markets, { defaultGlobal: true }), "GLOBAL");
  assert.equal(
    suggestMarketCode(markets, {
      defaultGlobal: true,
      preferredMarketId: "za",
    }),
    "ZA",
  );
});
