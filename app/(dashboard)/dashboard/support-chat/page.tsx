    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4">
        {[
          ...
          <div
            key={s.id}
            className="flex flex-col items-center gap-1 rounded-xl border border-gray-200 bg-white px-2 py-3 text-center sm:flex-row sm:gap-4 sm:px-5 sm:py-4 sm:text-left"
          >
            <div
              className={`flex h-9 w-9 items-center justify-center rounded-lg sm:h-10 sm:w-10 ${s.color}`}
            >
      ...
      {/* Main split layout */}
      <div className="flex h-[calc(100dvh-15rem)] min-h-[28rem] gap-5 lg:h-[calc(100vh-280px)] lg:min-h-[500px]">
        {/* Left: conversation list */}
        <div
          className={`${selected ? "hidden lg:flex" : "flex"} w-full shrink-0 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white lg:w-80`}
        >
          {/* Tabs */}
        ...
        >
          {!selected ? (
            ...
            <>
              {/* Chat header */}
              <div className="flex shrink-0 items-center justify-between gap-2 border-b border-gray-100 px-3 py-3 sm:px-5">
                ...
                <div className="shrink-0 border-t border-gray-100 bg-amber-50 px-3 py-3 sm:px-4">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      ...
                      className="w-full rounded-lg bg-green-600 px-4 py-1.5 text-xs font-medium text-white transition-colors hover:bg-green-700 disabled:opacity-50 sm:w-auto"
                    >
